...
class Particle(object):
    ...
    def __init__(self,x=1.0,y=1.0,theta=0.0,w=1.0):
...
class ParticleFilter:
    ...
    def __init__(self):
        ...
        self.sigma = 0.10               # guess for how inaccurate lidar readings are in meters
        ...
        self.particle_pub = rospy.Publisher("particlecloud_rmi", PoseArray, queue_size=10)
        self.marker_pub = rospy.Publisher("arraymarker", MarkerArray, queue_size=10)
    ...
    def update_robot_pose(self):
        ...
        self.robot_pose = Particle(x, y, theta).as_pose()
    ...
    def update_particles_with_odom(self, msg):
        ...
        for particle in self.particle_cloud:
            ...
            #Cria o filtro de particulas em formato redondo
    ...
    def update_particles_with_laser(self, msg):
        ...
        print self.position, self.closest

        # print msg, '/scan'
        for index, particle in enumerate(self.particle_cloud):
        #     tot_prob = 0
        #     for index, scan in enumerate(msg.ranges):
            x,y = self.transform_scan(particle, self.closest, index)
        ...
        #         # print math.exp((-d**2)/(2*self.sigma**2)), 'd_r'
    ...
    def publish_particles(self, msg):
        ...
        # Publica as particulas no rviz (pointcloud_rmi)
    ...
    def scan_received(self, msg):
        ...
        # print self.laser_pose, 'self.laser_pose'

        # find out where the robot thinks it is based on its odometry
        # listener.getLatestCommonTime("/base_link",object_pose_in.header.frame_id)
        # p = PoseStamped(header=Header(stamp=msg.header.stamp,
        p = PoseStamped(header=Header(stamp=self.tf_listener.getLatestCommonTime("/base_link","/map"),
    ...
    def fix_map_to_odom_transform(self, msg):
        ...
        p = PoseStamped(pose=convert_translation_rotation_to_pose(translation,rotation),
                        ...
                        header=Header(stamp=self.tf_listener.getLatestCommonTime("/base_link","/map"),frame_id=self.base_frame))
